...
def main():
    st.set_page_config(page_title="Chatbot 101", page_icon=":books:")
    ...
    with st.sidebar:
        ...
        uploaded_file = st.file_uploader("Upload book PDFs here", type=["pdf"])
    ...
    st.title("Chatbot 101")
    st.header("Welcome to Chatbot 101")
